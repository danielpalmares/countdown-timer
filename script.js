...
function countdown() {
  ...
  secondsEl.innerHTML = seconds !== null ? formatTime(seconds) : 0;
  minutesEl.innerHTML = minutes !== null ? formatTime(minutes) : 0;
  hoursEl.innerHTML = hours !== null ? formatTime(hours) : 0;
  daysEl.innerHTML = days !== null ? formatTime(days) : 0;
}
countdown();
